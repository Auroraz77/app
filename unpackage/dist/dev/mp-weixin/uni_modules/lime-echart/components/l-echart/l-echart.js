...
const _sfc_main = common_vendor.defineComponent({
  ...
  setup(props, { emit, expose }) {
    ...
    const init = async (echartsLib = echartsLibrary, ...args) => {
      ...
      if (!library) {
        common_vendor.index.__f__("error", "at uni_modules/lime-echart/components/l-echart/l-echart.vue:304", "ECharts library is required");
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    e: _ctx.canvasId,
    f: common_vendor.o((...args) => _ctx.handleTouchStart && _ctx.handleTouchStart(...args), "af"),
    g: common_vendor.o((...args) => _ctx.handleTouchMove && _ctx.handleTouchMove(...args), "07"),
    h: common_vendor.o((...args) => _ctx.handleTouchEnd && _ctx.handleTouchEnd(...args), "07"),
